  ...
  public navbarList: NavbarItemInterface[] = [
    {
      ...
      link: '/feed',
      icon: 'assets/imgs/icons/navbar_feed_disabled.svg',
      iconActivated: 'assets/imgs/icons/navbar_feed_enabled.svg',
    },
    {
      type: NavbarEnum.HOME,
      link: '/home',
      icon: 'assets/imgs/icons/navbar_home_disabled.svg',
      iconActivated: 'assets/imgs/icons/navbar_home_enabled.svg',
    },
    {
      type: NavbarEnum.PROFILE,
      link: '/profile',
      icon: 'assets/imgs/icons/navbar_profile_disabled.svg',
      iconActivated: 'assets/imgs/icons/navbar_profile_enabled.svg',
    }
  ]
